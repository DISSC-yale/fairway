...
4. Use default model preference policy for staffing: prioritize Anthropic + OpenAI + direct Google providers, prefer latest generation (latest two eligible), favor OpenAI codex variants, hard-avoid github-copilot unless explicitly requested.
